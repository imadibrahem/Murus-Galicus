...
public class MoveSortingPlayer extends Player{
    ...
    private void updateHistoryTable(Move move, int depth, boolean isMax, boolean isBlue) {
        if (isMax) maxHistoryTable [move.getInitialLocation(isBlue)][move.getDirection()] += depth * depth;
        else minHistoryTable [move.getInitialLocation(isBlue)][move.getDirection()] += depth * depth;
    }
