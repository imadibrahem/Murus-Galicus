...
public class RoundsFactorChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public RoundsFactorChromosome(){
        super(20, -20, 0.1f);
        produceValue();
    }
    public RoundsFactorChromosome(float mutationRate) {
        super(20, -20, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #08 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new RoundsFactorChromosome(mutationRate);
        Chromosome secondChild = new RoundsFactorChromosome(mutationRate);
