...
public class SixthHabitatPlayerAndMoves {
    //Individual{exploration=false, exploitation=false, mutationRate=0.1, genome=[[5], [1, 4, 2, 0, 3], [4, 8, 7, 5, 2, 1, 6, 3], [0], [16], [4], [4], [8], [7], [-10], [4], [0, 1, 2, 4, 3, 5], [2, 4, 3, 1, 0], [1, 0, 2], [1], [11], [12], [69], [19], [9]]}
