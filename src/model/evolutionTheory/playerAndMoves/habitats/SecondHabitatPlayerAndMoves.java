...
public class SecondHabitatPlayerAndMoves {
    //Individual{exploration=false, exploitation=false, mutationRate=0.1, genome=[[1], [3, 0, 2, 1, 4], [4, 8, 2, 5, 3, 1, 6, 7], [1], [9], [4], [7], [8],
    // [8], [-11], [-4], [1, 3, 0, 2, 5, 4], [3, 1, 0, 2, 4], [1, 0, 2], [1], [4], [9], [40],16],[8]]}
