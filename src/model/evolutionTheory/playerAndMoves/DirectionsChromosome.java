...
public class DirectionsChromosome extends IntegerPermutationArrayValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public DirectionsChromosome(){
        super(1, 8, 0.1f);
        produceValue();
    }
    public DirectionsChromosome(float mutationRate) {
        super(1, 8, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #02 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new DirectionsChromosome(mutationRate);
        Chromosome secondChild = new DirectionsChromosome(mutationRate);
