...
public class DistancesFactorChromosome  extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public DistancesFactorChromosome(){
        super(20, -20, 0.1f);
        produceValue();
    }
    public DistancesFactorChromosome(float mutationRate) {
        super(20, -20, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #10 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new DistancesFactorChromosome(mutationRate);
        Chromosome secondChild = new DistancesFactorChromosome(mutationRate);
