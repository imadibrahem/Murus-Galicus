...
public class EndFactorChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public EndFactorChromosome(){
        super(25, 5, 0.1f);
        produceValue();
    }

    public EndFactorChromosome(float mutationRate) {
        super(25, 5, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #19 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new EndFactorChromosome(mutationRate);
        Chromosome secondChild = new EndFactorChromosome(mutationRate);
