...
public class MidFactorChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public MidFactorChromosome(){
        super(20, 10, 0.1f);
        produceValue();
    }

    public MidFactorChromosome(float mutationRate) {
        super(20, 10, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #18 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new MidFactorChromosome(mutationRate);
        Chromosome secondChild = new MidFactorChromosome(mutationRate);
