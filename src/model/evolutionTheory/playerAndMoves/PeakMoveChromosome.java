...
public class PeakMoveChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public PeakMoveChromosome(){
        super(20, 1, 0.1f);
        produceValue();
    }
    public PeakMoveChromosome(float mutationRate) {
        super(20, 1, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #15 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new PeakMoveChromosome(mutationRate);
        Chromosome secondChild = new PeakMoveChromosome(mutationRate);
