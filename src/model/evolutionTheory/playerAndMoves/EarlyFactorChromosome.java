...
public class EarlyFactorChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public EarlyFactorChromosome(){
        super(75, 40, 0.1f);
        produceValue();
    }

    public EarlyFactorChromosome(float mutationRate) {
        super(75, 40, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #17 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new EarlyFactorChromosome(mutationRate);
        Chromosome secondChild = new EarlyFactorChromosome(mutationRate);
