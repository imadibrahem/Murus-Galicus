...
public class FullDepthMoveNumberChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public FullDepthMoveNumberChromosome(){
        super(12, 1, 0.1f);
        produceValue();
    }
    public FullDepthMoveNumberChromosome(float mutationRate) {
        super(12, 1, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #07 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new FullDepthMoveNumberChromosome(mutationRate);
        Chromosome secondChild = new FullDepthMoveNumberChromosome(mutationRate);
