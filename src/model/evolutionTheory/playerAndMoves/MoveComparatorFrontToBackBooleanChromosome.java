...
public class MoveComparatorFrontToBackBooleanChromosome extends BooleanValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public MoveComparatorFrontToBackBooleanChromosome(){
        super(0.1f);
        produceValue();
    }

    public MoveComparatorFrontToBackBooleanChromosome(float mutationRate) {
        super(mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #14 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new MoveComparatorFrontToBackBooleanChromosome(mutationRate);
        Chromosome secondChild = new MoveComparatorFrontToBackBooleanChromosome(mutationRate);
