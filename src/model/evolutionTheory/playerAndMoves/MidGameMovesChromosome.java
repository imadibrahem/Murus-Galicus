...
public class MidGameMovesChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public MidGameMovesChromosome(){
        super(20, 1, 0.1f);
        produceValue();
    }
    public MidGameMovesChromosome(float mutationRate) {
        super(20, 1, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #16 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new MidGameMovesChromosome(mutationRate);
        Chromosome secondChild = new MidGameMovesChromosome(mutationRate);
