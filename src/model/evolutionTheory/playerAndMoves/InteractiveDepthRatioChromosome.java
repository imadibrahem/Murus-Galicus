...
import model.evolutionTheory.evaluationFunction.MobilityFactorChromosome;

import java.io.Serial;
import java.io.Serializable;

public class InteractiveDepthRatioChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public InteractiveDepthRatioChromosome(){
        super(8, 1, 0.1f);
        produceValue();
    }
    public InteractiveDepthRatioChromosome(float mutationRate) {
        super(8, 1, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #06 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new InteractiveDepthRatioChromosome(mutationRate);
        Chromosome secondChild = new InteractiveDepthRatioChromosome(mutationRate);
