...
public class MoveComparatorMoveTypesChromosome extends IntegerPermutationArrayValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public MoveComparatorMoveTypesChromosome(){
        super(0, 5, 0.1f);
        produceValue();
    }
    public MoveComparatorMoveTypesChromosome(float mutationRate) {
        super(0, 5, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #12 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new MoveComparatorMoveTypesChromosome(mutationRate);
        Chromosome secondChild = new MoveComparatorMoveTypesChromosome(mutationRate);
