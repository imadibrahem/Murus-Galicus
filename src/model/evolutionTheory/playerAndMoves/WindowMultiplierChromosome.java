...
public class WindowMultiplierChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public WindowMultiplierChromosome(){
        super(6, 1, 0.1f);
        produceValue();
    }

    public WindowMultiplierChromosome(float mutationRate) {
        super(6, 1, mutationRate);
    }
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new WindowMultiplierChromosome(mutationRate);
        Chromosome secondChild = new WindowMultiplierChromosome(mutationRate);
