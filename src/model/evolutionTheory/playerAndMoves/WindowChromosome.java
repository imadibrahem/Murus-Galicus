...
public class WindowChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    protected static final long serialVersionUID = 1L;

    public WindowChromosome(){
        super(25, 5, 0.1f);
        produceValue();
    }

    public WindowChromosome(float mutationRate) {
        super(25, 5, mutationRate);
    }

    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #04 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new WindowChromosome(mutationRate);
        Chromosome secondChild = new WindowChromosome(mutationRate);
