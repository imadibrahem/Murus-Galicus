...
public class TowersDistancesFactorChromosome extends IntegerNormalArrayValueChromosome implements Serializable {
    @Serial
    ...
    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #2 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new TowersDistancesFactorChromosome(mutationRate);
        Chromosome secondChild = new TowersDistancesFactorChromosome(mutationRate);
