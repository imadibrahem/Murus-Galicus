...
public class WallsColumnsFactorChromosome extends IntegerNormalArrayValueChromosome implements Serializable {
    @Serial
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new WallsColumnsFactorChromosome(mutationRate);
        Chromosome secondChild = new WallsColumnsFactorChromosome(mutationRate);
