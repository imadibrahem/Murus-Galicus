...
public class WallsDistancesFactorChromosome extends IntegerNormalArrayValueChromosome implements Serializable {
    @Serial
    ...
    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #0 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new WallsDistancesFactorChromosome(mutationRate);
        Chromosome secondChild = new WallsDistancesFactorChromosome(mutationRate);
