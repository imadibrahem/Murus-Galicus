...
public class IsolatedTowersFactorChromosome extends IntegerSingleValueChromosome implements Serializable {
    @Serial
    ...
    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #7 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        Chromosome firstChild = new IsolatedTowersFactorChromosome(mutationRate);
        Chromosome secondChild = new IsolatedTowersFactorChromosome(mutationRate);
