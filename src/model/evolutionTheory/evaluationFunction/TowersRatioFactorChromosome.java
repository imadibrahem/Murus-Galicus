...
public class TowersRatioFactorChromosome extends IntegerNormalArrayValueChromosome implements Serializable {
    @Serial
    ...
    @Override
    public void mutate() {
        System.out.println("mutation for Chromosome #4 is being applied ");
    ...
    public Chromosome[] crossover(Chromosome partner) {
        ...
        float randomIndex;
        Chromosome firstChild = new TowersRatioFactorChromosome(mutationRate);
        Chromosome secondChild = new TowersRatioFactorChromosome(mutationRate);
